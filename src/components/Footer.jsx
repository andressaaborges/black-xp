            ...
            <div className={styles.containerSecond}>
                ...
                <div className={styles.form}>
                    ...
                    <div className={styles.contact}>
                        <a href="/" target="_blank" download><p>Termos e Condições</p></a>
                        <a href="mailto:aimotech@gmail.com" target="_blank"><p>aimotech@gmail.com</p></a>
                        <div className={styles.social}>
                            <a href="https://www.instagram.com/aimo.tech" target="_blank"><InstagramLogo size={30} weight="light" /></a>
                            <a href="/" target="_blank"><WhatsappLogo size={30} weight="fill" /></a>
                        </div>
                    </div>
                </div>
            </div>
